...
const Cards = () => {
  ...
  return (
    <>
      {todolist.length === 0 ? (
        <div>
          {/* <p className="text-center mt-4 text-gray-500 mt-3">No cards to display - add a new one</p> */}
          <div className="w-auto  flex items-center justify-center flex-col mt-5 gap-5"  style={{ minHeight: `calc(100vh - 56px - 72px - 54px - 20px)` }}>
            <div
              className="note-add-icon bg-white hover:bg-[#f8f6f7] rounded-full cursor-pointer group transition-all hover:scale-110 p-1"
              title="Paste a new note"
